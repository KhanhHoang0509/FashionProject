...
import com.fashion.fashioncommon.entity.Role;
...
public class UserService {
    ...
    public boolean isPasswordAlreadyExist(Integer id, String password) {
        User oldPasswordByUser = userRepo.getPasswordByUser(password);

        if (oldPasswordByUser == null) {
            return false;
        } else {
            return true;
        }
