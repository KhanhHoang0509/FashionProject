...
import com.fashion.admin.brand.BrandService;
import com.fashion.admin.category.CategoryService;
import com.fashion.admin.productSize.ProductSizeService;
...
public class ProductController {
	...
	public String saveProduct(Product product, RedirectAttributes ra,
			...
			@AuthenticationPrincipal FashionUserDetails loggedUser) throws IOException {
	...
	@GetMapping("/products/{id}/hot_product/{status}")
	public String updateProductHotStatus(@PathVariable("id") Integer id, @PathVariable("status") boolean enabled, RedirectAttributes redirectAttributes) {
		productService.updateProductHotStatus(id, enabled);
		String status = enabled ? "enabled" : "disabled";
		String message = "The Hot Product ID " + id + " has been " + status;
	...
	public String editProduct(@PathVariable("id") Integer id, Model model,
			RedirectAttributes ra, @AuthenticationPrincipal FashionUserDetails loggedUser) {
		try {
